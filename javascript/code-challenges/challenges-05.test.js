        ...
        const toLastNames = names => {
          let edit = [];
          names.map(( firstandlastname ) => {
          edit.push( firstandlastname.firstName + ' ' + firstandlastname.lastName );
          }
          );
          return edit;
        };
        ...
        const addValues = (edit) => {
          let sumOfValues = edit.reduce(( num, value ) =>
          { return num + value; } , 0 );
          return sumOfValues;
        };
        ...
        const addPurchases = (edit) => {
          let totalAmount = edit.reduce( ( numbersSum, item ) => {
          return numbersSum + item.purchasePrice; } , 0 );
          return totalAmount;
          };
        ...
        const countNumberOfElements = (arr) => {
          let totalAmount = arr.reduce( ( count ) => { 
          return count + 1;} , 0 ) ;
          return totalAmount;
          };
        ...
        const returnNames = (edit) => {
          const characters = edit.reduce((s, a, count) => {
          s[count] = a.name;
          return s; } , [] );
          return characters;
        };
        ...
        const reversedString = (enter) => {
          const edit = enter.split('');
          const rev = edit.reduce ( ( w , l ) => 
          { return l + w;} , '' );
          return rev; 
        };
